...
<% 
	...
	long numMax = 0;
	if(request.getAttribute("historico") == null) { 
		numMax = gHelper.getNumMaxRegistrosExibir(empresaVo.getIdEmprCdEmpresa());
	} else {
		numMax = gHelper.getNumMaxRegistrosExibirHistorico(empresaVo.getIdEmprCdEmpresa());
	}
%>
