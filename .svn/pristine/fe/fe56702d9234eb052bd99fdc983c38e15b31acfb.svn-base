...
<script type="text/javascript">
	var CONS_ID_EMPR_CD_EMPRESA = '<%=empresaVo.getIdEmprCdEmpresa()%>';
	...
	//Variaveis para abertura de chamado
	var localizadorAtendimentoAction = '<%=Geral.getActionProperty("localizadorAtendimentoAction", empresaVo.getIdEmprCdEmpresa())%>';
	var TELA_LST_REGISTRO = '<%=MCConstantes.TELA_LST_REGISTRO%>';
	var ACAO_CONSULTAR = '<%=Constantes.ACAO_CONSULTAR%>'; 
	
	var CONS_VC_NAO_TEM_PERMISSAO = '<plusoft:message modulo="Crm"  key="prompt.voceNaoTemPermissaoParaAlterarEsteChamado" />';
	var CONS_NAO_ENCONTRADA_MANIFESTACAOES = '<plusoft:message modulo="Crm"  key="prompt.naoForamEncontradasManifestacoesParaEsteNumero" />';
	var CONS_DESEJA_ALTERAR_MANIFESTACAO = '<plusoft:message modulo="Crm"  key="prompt.Tem_certeza_que_deseja_editar_a_manifestacao_selecionada" />';
