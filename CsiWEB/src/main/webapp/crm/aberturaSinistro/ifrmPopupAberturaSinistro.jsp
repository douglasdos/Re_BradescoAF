			...
			<div class="shadow">
									...
									<tbody>
										<tr id="trCloneDetalhe" style="display: none;">
											<td class="listDetalheBemSinistrado-lixeira" id="tdDetExcluir">
												<button class="transparent" title="Excluir" id="btnDetExcluirDetalhe">
													<img src="../resources/assets/imgs/lixeira.gif" alt="Excluir">
												</button>
											</td>
				...
				<div id="responsavel" data-content style="display: none">
					<fieldset class="col-12" style="height: 148px">
						...
						<div class="line">
							<label for="txtRespBairro" class="col-5">Bairro</label>
							<input type="text" name="txtRespBairro" id="txtRespBairro" class="col-16">
						</div>
						<div class="line">
					...
					<fieldset class="col-12" style="height: 148px">
						...
						<div class="line">
							...
							<label for="txtRespCodigoBanco" class="col-5">Banco</label>
							<input type="text" name="txtRespCodigoBanco" id="txtRespCodigoBanco" class="col-3">
							<input type="text" name="txtRespDescricaoBanco" id="txtRespDescricaoBanco" class="col-3">							
						</div>
						<div>
							<label for="cmbRespOutros" class="col-5">Outros</label>
							<select name="cmbRespOutros" id="cmbRespOutros" class="col-17"></select>
						</div>
						<div class="line">
						...
						<div class="line">
							...
							<input type="text" name="txtRespAgencia" id="txtRespAgencia" class="col-5">

							<label for="txtRespConta" class="col-4">Conta</label>
							<input type="text" name="txtRespConta" id="txtRespConta" class="col-5">
									...
									<tbody>
										<tr id="trCloneOutros" style="display: none;">
											<td class="listOutrosEnvolvidos-lixeira" id="tdOutExcluit">
												<button class="transparent" title="Excluir" id="btnOutExcluir">
													<img src="../resources/assets/imgs/lixeira.gif" alt="Excluir">
												</button>
											</td>
