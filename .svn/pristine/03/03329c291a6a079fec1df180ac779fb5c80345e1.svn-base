(function($){
	...
	$(document).ready(function(){
		...
		carregarApolices = function() {
			...
			//Carregar a tabela temporaria usada para armazenar as informações de apolices
			$.ajax({
				...
				alert('ERRO AO EXECUTAR O SERVIÇO DE LISTA DE APÓLICE TEMPORÁRIA\nMétodo: "carregarListaApoliceTemporaria"\nDescrição: ' + erro);
