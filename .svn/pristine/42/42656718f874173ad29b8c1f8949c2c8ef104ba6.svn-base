...
function connect(server, port, place, usuario, agente, senha, ramal, grupo,servico){
	var url = "";
	url= url + "evento=connect&server=" + server + "&port=" + port;
...
*/
function login(aditionalCommand){
	var url = "";
	url= url + "evento=login";
	url= url + "&place=" + gplace;
	url= url + "&usuario=" + gusuario;
	url= url + "&agente=" + gagente;
	url= url + "&senha=" + gsenha;
	url= url + "&ramal=" + gramal;
	url= url + "&grupo=" + ggrupo;
	url= url + "&ctiServico=" + gservico;
	url= url + aditionalCommand;
...
*/
function transfer(phone, grupo,vName,vVal){
	var url = "";
	var i = 0;
	url= url + "evento=tranfer&phone="+phone + "&grupo=" + grupo;
