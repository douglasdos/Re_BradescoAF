/**
 * ObterListaPorRaizCepResponse.java
 *
...
public class ObterListaPorRaizCepResponse  implements java.io.Serializable {
    private br.com.bradseg.ccep.consultacep.presentation.consultacep.webservice.CepWebServiceResponse _return;

    public ObterListaPorRaizCepResponse() {
    }
    ...
    /**
     * Gets the _return value for this ObterListaPorRaizCepResponse.
     * 
     * @return _return
     */
    ...
    /**
     * Sets the _return value for this ObterListaPorRaizCepResponse.
     * 
     * @param _return
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ObterListaPorRaizCepResponse)) return false;
        ObterListaPorRaizCepResponse other = (ObterListaPorRaizCepResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ObterListaPorRaizCepResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservice.consultacep.presentation.consultacep.ccep.bradseg.com.br/", "obterListaPorRaizCepResponse"));
