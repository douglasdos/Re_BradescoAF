...
<% 
	...
	String qtdadeLinha = (String)AdministracaoCsDmtbConfiguracaoConfHelper.findConfiguracao(ConfiguracaoConst.CONF_LIMITE_LINHAS_RESULTADO_CLASSIF_EMAIL, empresaVo.getIdEmprCdEmpresa());
	long numMax = !qtdadeLinha.equals("") ? Long.parseLong(qtdadeLinha) : 0;
%>
