...
<body>
	<html:form styleId="aberturaSinistroForm">
		...
		<div class="col-24 align-right">
			<button id="btnIncluirComunicado" type="button" class="transparent disabled" title="Incluir Comunicado de Sinistro" style="height: 38px">
				<img src="../resources/assets/imgs/INFO1.gif" alt="Incluir Comunicado de Sinistro" style="height: 25px">
			</button>
		</div>
	</html:form>
