(function($){
	...
	configurarControleResponsavel = function() {
		...
		configurarControlePadrao($("#txtRespNumero"),'0#','10',true);
		...
		carregarComboOutros($("#cmbRespOutros"),true);
		...
		configurarControlePadrao($("#txtRespAgenciaDv"),'0#','2',true);
		...
		$("#chkRespMesmoEndereco").trigger('click');
		$("#chkRespProprioSegurado").trigger('click');
		$("#chkRespNaoTemContaBanco").trigger('click');
	...
	carregarEnderecoResponsavel = function(apolice) {
		...
		$("#txtRespNumero").val(apolice.numeroEnderecoSegurado);
	...
	$("#chkRespProprioSegurado").bind('change' , function(){
		...
		if($(this).is(':checked') == false) {
			...
			carregarComboOutros($("#cmbRespOutros"),false);
	...
	funcHabilitarCamposResponsavel = function() {
		...
		$("#txtRespNumero").removeAttr('readonly');
	...
	funcDesabilitarCamposResponsavel = function() {
		...
		$("#txtRespNumero").attr('readonly' , 'readonly');
	...
	funcHabilitarCamposBanco= function() {
		...
		$("#txtRespAgenciaDv").removeAttr('readonly');
	...
	funcDesabilitarCamposBanco = function() {
		...
		$("#txtRespAgenciaDv").attr('readonly' , 'readonly');
	...
	funcAbrirListaConta = function() {
		...
		if (isEmpty($("#txtRespCpfBeneficiario"))) {
			alert('Informe o CPF/CNPJ do beneficiário.');
			return false;
		}
	...
	carregarComboOutros = function(cmbRespOutros,proprioSegurado) {
		cmbRespOutros.empty();
		
		if (proprioSegurado == true) {
			cmbRespOutros.append($("<option></option>").val('01').html('SEGURADO'));
			cmbRespOutros.val('01');
			cmbRespOutros.attr('disabled' , true);
		} else {
			cmbRespOutros.append($("<option></option>").val("").html("Selecione uma opção"));
			cmbRespOutros.append($("<option></option>").val('02').html('CORRETOR'));
			cmbRespOutros.append($("<option></option>").val('03').html('CÔNJUGE'));
			cmbRespOutros.append($("<option></option>").val('04)').html('FILHO(A)'));
			cmbRespOutros.append($("<option></option>").val('05').html('OUTROS'));
			cmbRespOutros.append($("<option></option>").val('07').html('SUCURSAL'));
			cmbRespOutros.append($("<option></option>").val('08').html('PAI'));
			cmbRespOutros.append($("<option></option>").val('09').html('MÃE'));
			cmbRespOutros.append($("<option></option>").val('10').html('EMPREGADO(A)'));
			cmbRespOutros.attr('disabled' , false);
		}
	};
